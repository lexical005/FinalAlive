...
public struct FVector2
{
    ...
    public static FVector2 Create(FInt X, FInt Y)
    {
        FVector2 fp;
        fp.X = X;
        fp.Y = Y;
    ...
    public static FVector2 VectorAdd(FVector2 F1, FVector2 F2)
    {
        FVector2 result;
        result.X = F1.X + F2.X;
        result.Y = F1.Y + F2.Y;
    ...
    public static FVector2 VectorSubtract(FVector2 F1, FVector2 F2)
    {
        FVector2 result;
        result.X = F1.X - F2.X;
        result.Y = F1.Y - F2.Y;
    ...
    public static FVector2 VectorDivide(FVector2 F1, int Divisor)
    {
        FVector2 result;
...
public struct FVector3
{
    ...
    public static FVector3 Create(FInt X, FInt Y, FInt Z)
    {
        FVector3 fp;
        fp.X = X;
        fp.Y = Y;
    ...
    #region Vector Operations
    public static FVector3 VectorAdd(FVector3 F1, FVector3 F2)
    {
        FVector3 result;
        result.X = F1.X + F2.X;
        result.Y = F1.Y + F2.Y;
    ...
    public static FVector3 VectorSubtract(FVector3 F1, FVector3 F2)
    {
        FVector3 result;
        result.X = F1.X - F2.X;
        result.Y = F1.Y - F2.Y;
    ...
    public static FVector3 VectorDivide(FVector3 F1, int Divisor)
    {
        FVector3 result;
        result.X = F1.X / Divisor;
        result.Y = F1.Y / Divisor;
        result.Z = F1.Z / Divisor;
        return result;
    }
    #endregion
}
